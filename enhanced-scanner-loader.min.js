...
(function () {
    ...
    if (window.selmaDebugLocal) {
        console.log('🔧 selmaDebugLocal is enabled - loading from local sources');
    }
    ...
    const SCANNER_CONFIG = {
        baseUrl: window.selmaDebugLocal ? './' : 'https://cdn.jsdelivr.net/gh/kaalione/selma-js-assets@latest/',
        version: '3.0.1',
    ...
    window.ScannerLoader = {
        ...
        loadFallback: function () {
            ...
            // Skip fallback in debug mode
            if (window.selmaDebugLocal) {
                this.log('❌ FALLBACK SKIPPED - Debug mode active', 'error');
                this.log('Check console for errors. Scanner modules failed to load.', 'error');
                return; // Don't load fallback
            }
