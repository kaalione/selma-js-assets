...
(function() {
    ...
    const SCANNER_CONFIG = {
        ...
        baseUrl: 'https://cdn.jsdelivr.net/gh/kaalione/selma-js-assets@8d454f4/',
    ...
    window.ScannerLoader = {
        ...
        loadModule: function(moduleName, callback, useFallback = false) {
            ...
            script.src = baseUrl + SCANNER_CONFIG.modules[moduleName] + '?v=' + SCANNER_CONFIG.cacheBuster;
            script.async = true;
            script.defer = true;
