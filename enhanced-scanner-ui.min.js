...
(function () {
    ...
    window.ScannerUI = {
        ...
        createContactModal: function (sessionData = null) {
            ...
            modal.style.cssText = 'display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); z-index: 1000010; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.3s ease-in-out;';

            console.log('Creating simplified contact modal');
            ...
            modal.innerHTML = `
                <div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; padding: 20px;">
                    <div style="background: white; border-radius: 16px; padding: 40px; max-width: 500px; width: 90%; font-family: 'Nunito Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; text-rendering: optimizeLegibility; box-shadow: 0 10px 40px rgba(30, 60, 114, 0.15); position: relative; overflow: hidden;">
                        ...
                        <p style="margin: 0 0 30px 0; color: #666;">Vi scannar <strong>${domain}</strong> just nu. Fyll i din kontaktinfo så får du direkt tillgång till resultatet.</p>
                        
                        <form id="contactForm" data-scanner-enhanced="true">
                            <input type="email" id="contactEmail" name="email" placeholder="E-postadress" required autofocus
                                   style="width: 100%; padding: 12px; margin-bottom: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 14px; transition: border-color 0.2s; box-sizing: border-box;">
                            
                            <input type="tel" id="contactPhone" name="phone" placeholder="Telefonnummer" required
                                   style="width: 100%; padding: 12px; margin-bottom: 10px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 14px; transition: border-color 0.2s; box-sizing: border-box;">
        ...
        hideContactModal: function () {
            if (this.elements.contactModal) {
                this.elements.contactModal.style.opacity = "0";
                setTimeout(() => {
