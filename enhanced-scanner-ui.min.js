        ...
        createContactModal: function (sessionData = null) {
            ...
            modal.innerHTML = `
                ...
                <div id="contact-modal">
                    <div class="simple-contact-box">
                        <h2>Get Your Accessibility Report</h2>
                        <p>Enter your contact information to view the full accessibility analysis</p>
