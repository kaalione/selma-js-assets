...
(function () {
    ...
    window.ScannerUI = {
        ...
        createContactModal: function (sessionData = null) {
            ...
            recoScript.src = "https://widget.reco.se/yearsInRowBadge/5858532.js";
            document.body.appendChild(recoScript);

            /*
            modal.innerHTML = `
            <div style="display:flex; align-items: center; justify-content: center; padding: 20px; box-sizing: border-box; height: 100%; overflow-y: auto;">
                <div class="contact-content" style="background-color: white; padding: 0; border-radius: 12px; width: 698px; max-width: 90%; box-shadow: 0 20px 40px rgba(0,0,0,0.2); overflow: hidden;">
                    ...
                    <div id="contactFormContainer" style="display: none;">
                        <div style="display: flex; align-items: stretch; min-height: 400px;">
                            ...
                            <div id="contactFormInnerContainer" style="flex: 1; padding: 30px 40px;">
                                <h2 id="contactModalTitle" style="margin: 0 0 8px 0; color: #1a1a1a; font-size: 24px; font-weight: 700; line-height: 1.3;">Din rapport är klar – lås upp hela analysen kostnadsfritt</h2>
                                ...
                                <form id="contactForm" style="display: flex; flex-direction: column;" data-scan-form="true">
                                    ...
                                    <div style="margin-bottom: 15px; display:flex; align-items: center; gap: 8px;">
                                        <div style="font-size: 12px; color: #666; line-height: 1.4;">
                                            <strong style="font-size:12px; display:block;">⭐ 4.8 / 5 baserat på verifierade kundomdömen på Reco.se.</strong> Vår kundavdelning kommer höra av sig för att hjälpa dig att förstå
                                            vad som påverkar din webbplats och hur du kan åtgärda det
                                        </div>
            ...
            */
            ...
            console.log('Generated report summary:', issuesDetails);
                                ...
                                <div class="inner">
                                    ...
                                    <div class="benefits-box">
                                        ...
                                        <div class="benefit-item">
                                            ...
                                            <p>Gratis rådgivning <strong>(värde 14900 kr)</strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <form id="contact-form">
                                        ...
                                        <div class="form-consent">
                                            ...
                                            <label for="consent">Jag har läst och godkänner villkoren för vår tjänst.</label>
                                        </div>
