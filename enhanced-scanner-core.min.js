...
(function () {
    ...
    window.EnhancedScanner = {
        config: {
            ...
            debugMode: true,
            contactModalDelay: window.selmaDebugLocal ? 3000 : 5000,
        },
        ...
        handleReportContactFormSubmit: function (e, form) {
            ...
            console.log('📧 Form submitted:', { email: this.session.contactInfo.email, phone: this.session.contactInfo.phone });
        ...
        startBackgroundReportLoading: function () {
            ...
            // Show contact modal after short delay
            setTimeout(() => {
                console.log("Showing contact modal short delay after background report loading");
            ...
            }, this.config.contactModalDelay ?? 3000);
        },
        ...
        processAccessiBeResults: function (data) {
            try {
                ...
                */
                ...
                // Contact modal is now shown early in startBackgroundReportLoading
                // No longer dependent on scan completion or compliance status
