...
(function () {
    ...
    window.EnhancedScanner = {
        ...
        init: function () {
            ...
            console.log("Enhanced Scanner Core v3.6 initializing...");
        ...
        findAndEnhanceForms: function () {
            ...
            formsToProcess.forEach(form => {
                ...
                if (urlField && !form.getAttribute("data-scanner-enhanced") && form.id !== "contact-form") {
            ...
            // All the above is just stupid - i'll just bind the contact form here
            const contactForm = document.getElementById("contact-form");
            if (contactForm && !contactForm.getAttribute("data-scanner-enhanced")) {
