...
(function() {
    ...
    try {
        ...
        script.addEventListener("error", () => {
            ...
            console.log("SearchAtlas unavailable (expected if API endpoint changed)");
            // Don't throw error, just log
        });
        
        document.head.appendChild(script);
    } catch (error) {
        console.log("SearchAtlas initialization skipped");
    }
},
        ...
        loadAccessiBeWidget: function() {
            ...
            try {
                ...
                script.async = true;
                script.defer = true;
                script.src = `${this.config.resources.accessibe.url}`;
